=== UserSumo - Improve Your Conversion Rates ===
Contributors: usersumo
Tags: conversions, conversion rate, conversions rates, sales, ecommerce, e-commerce, conversion optimization
...
Simply sign up for a [UserSumo account](https://usersumo.com) and install this plugin to get started.

Step-by-step Guide:

* Sign up for a UserSumo account if you haven't already.
* Install plugin from WordPress directory and activate it.
* Under UserSumo section, enter your UserSumo ID and save. Your UserSumo ID can be found [here](https://usersumo.com/member/widgets/)
